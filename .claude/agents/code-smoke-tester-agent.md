...
```bash
.claude/memory/agents/code-smoke-tester-agent/
...
- `agents/code-smoke-tester-agent/skills.md` - Technique works
- `agents/code-smoke-tester-agent/issues.md` - Problem + fix
- `agents/code-smoke-tester-agent/patterns.md` - Pattern effective
- `agents/code-smoke-tester-agent/notes.md` - Free-form insight
...
**Report filename:**
```
code-smoke-tester-agent_[jobslug]_[timestamp].md
```
...
```markdown
# Agent Report: code-smoke-tester-agent
